...
va(2) = (ua(2) * (m(2)-m(3)) + ua(3) * 2*m(3)) / (m23);     % final velocity of cart #2 after collision A, in cm/s
va(3) = (ua(3) * (m(3)-m(2)) + ua(2) * 2*m(2)) / (m23);     % final velocity of cart #3 after collision A, in cm/s
...
vb(1) = (ub(1) * (m(1)-m(2)) + ub(2) * 2*m(2)) / (m12);     % final velocity of cart #1 after collision B, in cm/s
vb(2) = (ub(2) * (m(2)-m(1)) + ub(1) * 2*m(1)) / (m12);     % final velocity of cart #2 after collision B, in cm/s
...
vc(2) = (uc(2) * (m(2)-m(3)) + uc(3) * 2*m(3)) / (m23);     % final velocity of cart #2 after collision C, in cm/s
vc(3) = (uc(3) * (m(3)-m(2)) + uc(2) * 2*m(2)) / (m23);     % final velocity of cart #3 after collision C, in cm/s
...
vd(1) = (ud(1) * (m(1)-m(2)) + ud(2) * 2*m(2)) / (m12);     % final velocity of cart #1 after collision D, in cm/s
vd(2) = (ud(2) * (m(2)-m(1)) + ud(1) * 2*m(1)) / (m12);     % final velocity of cart #2 after collision D, in cm/s
